...
## 🎉 Complete Desktop Extension for USRP Control
...
2. **Test Commands in Claude Desktop:**
   ...
   **Data Capture Examples:**
   ...
   Capture ISM band data at 915 MHz for analysis
   ```
   ...
   **Advanced Examples:**
   ...
   Create a frequency sweep from 2.4 to 2.5 GHz over 60 seconds
   ```
...
- `ICON_INSTRUCTIONS.md` - Guide for creating extension icons
